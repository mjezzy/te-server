...
import type { Thing, Url, UrlString } from "@inrupt/solid-client/interfaces";
...
export declare const setIri: SetOfType<string | Url | Readonly<{
    type: "Subject";
    url: import("../rdf.internal").BlankNodeId | import("../rdf.internal").LocalNodeIri | import("@inrupt/solid-client/interfaces").IriString;
