import type { WithServerResourceInfo, WithChangeLog } from "@inrupt/solid-client/interfaces";
import type { Access, AclDataset, WithAcl } from "@inrupt/solid-client/acl/acl";
/**
 * ```{note}
