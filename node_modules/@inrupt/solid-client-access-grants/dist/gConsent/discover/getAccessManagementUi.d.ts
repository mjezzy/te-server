 ...
 * @hidden
 */
export declare function getAccessManagementUiFromWellKnown(storage: UrlString | undefined, options: {
 ...
 * @since 0.4.0
 */
export declare function getAccessManagementUi(webId: URL | UrlString, options?: Pick<AccessBaseOptions, "fetch">): Promise<UrlString | undefined>;
