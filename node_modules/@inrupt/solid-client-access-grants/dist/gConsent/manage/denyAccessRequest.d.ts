...
import { type DatasetWithId, type VerifiableCredential } from "@inrupt/solid-client-vc";
 ...
 * @since 0.0.1
 */
export declare function denyAccessRequest(vc: DatasetWithId | VerifiableCredential | URL | UrlString, options: AccessBaseOptions & {
