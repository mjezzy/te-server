 ...
 * @since 0.4.0
 */
export declare function revokeAccessGrant(vc: DatasetWithId | VerifiableCredential | URL | UrlString, options?: Omit<AccessBaseOptions, "accessEndpoint">): Promise<void>;
