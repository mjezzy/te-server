...
export declare function saveSolidDatasetInContainer(containerUrl: UrlString, solidDataset: SolidDataset, accessGrant: VerifiableCredential | DatasetWithId, options: Parameters<typeof coreSaveSolidDatasetInContainer>[2]): Promise<Readonly<{
    type: "Dataset";
    graphs: Readonly<Record<import("@inrupt/solid-client").IriString, import("../../../solid-client/dist/rdf.internal").Graph> & {
        default: import("../../../solid-client/dist/rdf.internal").Graph;
    }>;
