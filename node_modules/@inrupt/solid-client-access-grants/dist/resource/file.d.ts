...
import { getFile as coreGetFile, overwriteFile as coreOverwriteFile, saveFileInContainer as coreSaveFileInContainer } from "@inrupt/solid-client";
 ...
 * @since 0.4.0
 */
export declare function getFile(resourceUrl: UrlString, accessGrant: VerifiableCredential | DatasetWithId, options?: Parameters<typeof coreGetFile>[1]): Promise<Blob & WithResourceInfo & {
    internal_resourceInfo: {
        aclUrl?: UrlString;
        contentLocation?: UrlString;
        linkedResources: import("@inrupt/solid-client/interfaces").LinkedResourceUrlAll;
        location?: UrlString;
        permissions?: {
 ...
 * @since 1.1.0
 */
export declare function overwriteFile<T extends File | NodeFile | Blob>(resourceUrl: UrlString, file: T, accessGrant: VerifiableCredential | DatasetWithId, options?: Parameters<typeof coreOverwriteFile>[2]): Promise<T & WithResourceInfo>;
/**
 ...
 * @since 1.1.0
 */
export declare function saveFileInContainer<T extends File | NodeFile | Blob>(containerUrl: UrlString, file: T, accessGrant: VerifiableCredential | DatasetWithId, options?: Parameters<typeof coreSaveFileInContainer>[2]): Promise<T & WithResourceInfo>;
