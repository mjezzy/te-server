 ...
 * @since 2.4.0
 */
export declare function deleteSolidDataset(datasetUrl: UrlString, accessGrant: VerifiableCredential | DatasetWithId, options?: Parameters<typeof coreDeleteSolidDataset>[1]): Promise<void>;
