 ...
 * @since 2.1.0
 */
export declare function createContainerInContainer(containerUrl: UrlString, accessGrant: VerifiableCredential | DatasetWithId, options?: Parameters<typeof solidClientCreateContainerInContainer>[1]): Promise<Readonly<{
    type: "Dataset";
