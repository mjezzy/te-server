 ...
 * @since 0.4.0
 */
export declare function getSolidDataset(datasetUrl: UrlString, accessGrant: VerifiableCredential | DatasetWithId, options?: Parameters<typeof coreGetSolidDataset>[1]): Promise<Readonly<{
    type: "Dataset";
